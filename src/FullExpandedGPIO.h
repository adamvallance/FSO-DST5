...
class FullExpandedGPIO{
    ...
    GPIOexpander general_GPIOexpander2= {&GPIO_EXPANDER_FRDM_PINS[3][0],  GPIO_EXPANDER_ADDRESSES[3], 3};
     ...
     public:
        ...
        //GPIOexpander* gpioExpanders[1] = {&general_GPIOexpander1};//debug, work on this to get interrupts going 
        //GPIOexpander* gpioExpanders[1] = {&general_GPIOexpander2}; //debug gpio only with leds etc
     private:
