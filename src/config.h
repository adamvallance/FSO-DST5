...
//#define HALF_STEP_TIME 8 //debug change this 
#define HALF_STEP_TIME 20ms //debug change this 
...
#define MOTOR_N_STEPS 100
//FAN
#define FAN_PWM_DUTY 1
...
//Motors Pin list
static PinName MOTOR_PINS[9] =  {PIN_MOTOR_1_STEP, PIN_MOTOR_1_DIR, PIN_MOTOR_2_STEP, PIN_MOTOR_2_DIR, PIN_MOTOR_DIR_CTRL_UP, PIN_MOTOR_DIR_CTRL_DOWN, PIN_MOTOR_DIR_CTRL_LEFT, PIN_MOTOR_DIR_CTRL_RIGHT, PIN_FRDM_LED_RED};
